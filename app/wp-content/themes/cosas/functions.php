...
function nyfw() {
	...
	$labels = array(
		'name'                  => _x( 'NYFW', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'nyfw', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'NYFW', 'text_domain' ),
		'name_admin_bar'        => __( 'nyfw', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	register_post_type( 'nyfw', $args );

}
add_action( 'init', 'nyfw', 0 );
